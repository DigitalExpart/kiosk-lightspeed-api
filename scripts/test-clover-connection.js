...
async function testCloverConnection() {
    ...
    try {
        ...
        const merchantResponse = await axios_1.default.get(`https://api.clover.com/v3/merchants/${CLOVER_MERCHANT_ID}`, {
            headers: {
        ...
        const ordersResponse = await axios_1.default.get(`https://api.clover.com/v3/merchants/${CLOVER_MERCHANT_ID}/orders`, {
            headers: {
                Authorization: `Bearer ${CLOVER_ACCESS_TOKEN}`,
                Accept: "application/json",
            },
...
//# sourceMappingURL=test-clover-connection.js.map