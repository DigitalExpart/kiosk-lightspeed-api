...
async function testLightspeedConnection() {
    ...
    if (!accountId) {
        ...
        try {
            ...
            const response = await axios_1.default.get("https://api.lightspeedapp.com/API/Account.json", {
                headers: {
    ...
    try {
        ...
        const accountResponse = await axios_1.default.get(`https://api.lightspeedapp.com/API/Account/${accountId}.json`, {
            headers: {
                Authorization: `Bearer ${LIGHTSPEED_PERSONAL_TOKEN}`,
                Accept: "application/json",
            },
        ...
        const shopResponse = await axios_1.default.get(`https://api.lightspeedapp.com/API/Account/${accountId}/Shop/${LIGHTSPEED_SHOP_ID}.json`, {
            headers: {
                Authorization: `Bearer ${LIGHTSPEED_PERSONAL_TOKEN}`,
                Accept: "application/json",
            },
        ...
        try {
            ...
            await axios_1.default.post(`https://api.lightspeedapp.com/API/Account/${accountId}/Sale.json`, {
                Sale: {
...
//# sourceMappingURL=test-lightspeed-connection.js.map